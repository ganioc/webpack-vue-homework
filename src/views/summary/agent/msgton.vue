...
import { getAgentMsgtons } from '@/api/user'
...
export default {
  ...
  mounted: function () {
    console.log('AgentGetMsgton mounted')
  ...
  methods: {
    handleCurrentPageChange(val) {
      ...
      this.getAgentMsgton(val, this.numPerPage)
    ...
    getAgentMsgton(curPage, numPerPage) {
      console.log('getAgentMsgton')
      console.log(curPage, numPerPage)
      getAgentMsgtons(curPage, numPerPage).then(
        (response) => {
        ...
        (err) => {
          console.log(err)
          console.log('getAgentMsgton failed')
        }
      )
    },
  },
