...
import { getAdminSmsHistory } from '@/api/user'
...
export default {
  ...
  mounted: function() {
    console.log('adminsmshistory mounted')
    this.getAdminSmsHistory(this.currentPage, this.numPerPage)
  },
  methods: {
    handleCurrentPageChange(val) {
      console.log(`当前页: ${val}`)
      // to load the new page
      this.getAdminSmsHistory(val, this.numPerPage)
      this.currentPage = val
    },
    handlePageSizeChange(val) {
      console.log(`每页 ${val} 条`)
    },
    getAdminSmsHistory(curPage, numPerPage) {
      console.log('getAdminSmsHistory')
      console.log(curPage, numPerPage)
      getAdminSmsHistory(curPage, numPerPage).then(
        response => {
        ...
        err => {
          console.log(err)
          console.log('getAdminSmsHistory failed')
        }
      )
    }
  }
