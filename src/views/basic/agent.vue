<template>
  <div class="dashboard-editor-container">
    ...
    >
      ...
      <el-table-column property="unused" label="剩余条数"></el-table-column>
      <el-table-column property="used" label="售出条数"></el-table-column>
...
export default {
  ...
  mounted: function() {
    ...
    this.getagents(this.currentPage, this.numPerPage)
  },
  computed: {},
  // watch: {
  ...
  methods: {
    ...
    getagents(curPage, numPerPage) {
      console.log('getagents')
      console.log(curPage, numPerPage)
      getAdminGetAgents(curPage, numPerPage).then(
        response => {
        ...
        err => {
          console.log(err)
          console.log('getAdminGetAgents failed')
        }
      )
    }
  }
